...
allGeneraTemp=[ZhangZhaoUpGenera;ZhangZhaoDownGenera;ForslundHildebrandUpGenera;ForslundHildebrandDownGenera];
avoidGenera={'Allobaculum','Clostridium','Butyricimonas', 'Oscillibacter','candidate division TM7','Rothia'};
allGenera={};
for i=1:length(allGeneraTemp)
    if ~any(strcmp(allGeneraTemp{i},avoidGenera))
        allGenera{end+1}=allGeneraTemp{i};
    end
end
allGenera=unique(allGenera);
